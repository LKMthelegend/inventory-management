                    ...
                    <div className='bg-white py-8 px-6 shadow rounded-lg sm:px-10'>
                        <form onSubmit={handleSubmit} className='mb-0 space-y-6'>
                            ...
                            <div>
                              ...
                              <div className='mt-1'>
                                <input id='licence' className='w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500' type="text" name="licence" value={formData.licence} onChange={handleChange}  autoComplete='off' required />
                              </div>
                            </div>
